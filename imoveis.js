...
function imvModalLanc(prefill, propOverride){
  ...
  imvOpenModal(`<button class="imv-x big" data-imv-close>×</button><h3>${pf.title||"Novo lançamento"}</h3>
    ...
    <div class="imv-f2"><div class="imv-field"><label>Unidade</label><select id="imv_lunit">${unitOpts}</select></div><div class="imv-field"><label>Descrição</label><input id="imv_ldesc" placeholder="Ex.: Aluguel do mês" value="${attr(pf.desc||"")}"></div></div>
